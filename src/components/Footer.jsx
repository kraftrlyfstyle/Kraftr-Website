const Footer = () => {
  return (
    <section id='Footer' className='flex flex-row py-16 w-full justify-between px-32 bg-[#f6f3ec]'>
      <div className='flex flex-col mx-4'>
        <p className='font-bold mb-2 tracking-widest text-xl'>KRAFTR</p>
        <p className='text-xs text'>Making a better future, one step at a time</p>
      </div>
      <div className='flex flex-col mx-4 text'>
      ...
      <div className='flex flex-col mx-4 w-56 text'>
